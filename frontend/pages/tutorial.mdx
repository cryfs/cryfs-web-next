...
- <a href="https://kde.org/applications/utilities/org.kde.plasmavault" target="_blank" rel="noopener noreferrer">Plasma Vault</a> (KDE Plasma) — Built into the KDE Plasma desktop, Plasma Vault integrates CryFS directly into your system tray for easy access to encrypted vaults.
</Alert>
...
<Console>
    ...
    <ConsoleOutput>CryFS Version 1.0.3</ConsoleOutput>
</Console>
...
2. Wait for your cloud service to sync the vault folder
...
- Disconnecting external drives containing your vaultdir
