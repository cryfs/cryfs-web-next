...
<ContentHeaderSection title="How it works" subtitle="We explain how CryFS works and why it is secure.">
  The description can be a bit technical in some points. If you're rather interested in using CryFS, take a look at the <Link href="/tutorial">CryFS Tutorial</Link>.
...
<Row>
<Col md="4">
<img src={StoringDataImg.src} alt="Your files, metadata and directory structure are stored as a set of same-size blocks, encrypted, and stored in the cloud." style={{maxWidth: "100%"}} />
</Col>
<Col md="8">
...
<img src={ConfigfileEncryptionImg.src} alt="Configuration File Encryption Layers" style={{maxWidth: "100%"}} />
</Col>
</Row>
        ...
        <Col style={{marginTop: '20px'}} md={{size: 8, offset: 2}}>
            <Card body style={{ backgroundColor: '#f5f5f5', borderColor: '#e3e3e3' }}>
                <div className="text-center">
                    ...
                    <Link legacyBehavior passHref href="/tutorial"><Button color="primary" size="lg">Tutorial</Button></Link>
                </div>
            </Card>
        </Col>
    </Row>
