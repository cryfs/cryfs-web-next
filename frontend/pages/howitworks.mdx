...
- **Metadata analysis**: Attackers cannot determine file sizes, names, types, permission bits, or directory structure
...
**Confidentiality:**
- **IND-aCCFA security**: Indistinguishability under adaptive chosen ciphertext file system attacks, proving that encrypted data reveals nothing about the plaintext (except the total size of the whole file system)
