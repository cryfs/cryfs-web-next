...
<Row>
<Col md="4">
<Image src={StoringDataImg} alt="Your files, metadata and directory structure are stored as a set of same-size blocks, encrypted, and stored in the cloud." style={{maxWidth: "100%", height: "auto"}} />
</Col>
<Col md="8">
...
<Image src={ConfigfileEncryptionImg} alt="Configuration File Encryption Layers" style={{maxWidth: "100%", height: "auto"}} />
</Col>
</Row>
        ...
        <Col style={{marginTop: '20px'}} md={{size: 8, offset: 2}}>
            <Card body style={{ backgroundColor: '#f5f5f5', borderColor: '#e3e3e3' }}>
                <div className="text-center">
                    ...
                    <Button as={Link} href="/tutorial" variant="primary" size="lg">Tutorial</Button>
                </div>
            </Card>
        </Col>
    </Row>
