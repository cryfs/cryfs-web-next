...
<Row className="g-4 mt-3 mb-4">
    <Col md="6" lg="4">
        <Link href="#block-storage" className="text-decoration-none">
    ...
    <Col md="6" lg="4">
        <Link href="#security-analysis" className="text-decoration-none">
            <Card className="h-100 border-0 shadow-sm" style={{cursor: 'pointer'}}>
                <Card.Body className="text-center">
    ...
    <Col md="6" lg="4">
        <Link href="#integrity" className="text-decoration-none">
            <Card className="h-100 border-0 shadow-sm" style={{cursor: 'pointer'}}>
                <Card.Body className="text-center">
