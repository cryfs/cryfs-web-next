...
<Row>
<Col md="4">
<Image src={StoringDataImg} alt="Your files, metadata and directory structure are stored as a set of same-size blocks, encrypted, and stored in the cloud." style={{maxWidth: "100%"}} />
</Col>
<Col md="8">
...
<Image src={ConfigfileEncryptionImg} alt="Configuration File Encryption Layers" style={{maxWidth: "100%"}} />
</Col>
</Row>
