...
While gocryptfs does encrypt file names, this is only <a href="https://github.com/rfjakob/gocryptfs-website/blob/master/docs/threat_model.md#file-size-fingerprinting">metadata obfuscation, not full metadata encryption</a>—the
