...
Furthermore, eCryptfs is [not designed for cloud storage](https://bugs.launchpad.net/ecryptfs/+bug/689030).
...
Gocrypfs, EncFS and eCryptfs don't encrypt directory structure. EncFS has [unpatched security vulnerabilities](https://defuse.ca/audits/encfs.htm) and is no longer actively maintained.
