...
It doesn't natively support Windows, and [macOS support is in beta](https://github.com/rfjakob/gocryptfs#macos). For Windows users, there is a third party client
...
The maintainer is working on a Rust port focused on reading legacy encrypted data, but [recommends gocryptfs](https://github.com/vgough/encfs#status) for new encrypted filesystem setups.
