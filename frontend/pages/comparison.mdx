...
<Row>
    <Col md={{size: 8, offset: 2}}>
        <Image src={ComparisonImg} style={{marginTop: '5px', marginBottom: '30px', width: '100%', height: 'auto'}} alt="Encrypting your Dropbox" />
    </Col>
</Row>
...
<Row>
<Col md="6">
    <Image src={VeraCryptImg} alt="VeraCrypt" className={styles.image} />
</Col>
<Col md="6">
...
<Col md="6">
<Image src={GocryptfsImg} alt="Gocryptfs" className={styles.image} />
</Col>
</Row>
...
<Row>
<Col md="6">
<Image src={EncfsImg} alt="EncFS" className={styles.image} />
</Col>
<Col md="6">
...
<Col md="7">
<Image src={ECryptFsImg} alt="eCryptfs" className={styles.image} />
</Col>
</Row>
...
<Row>
<Col md="6">
<Image src={CryFsImg} alt="CryFS" className={styles.image} />
</Col>
<Col md="5">
        ...
        <Col style={{marginTop: '20px'}} md={{size: 8, offset: 2}}>
            <Card body style={{ backgroundColor: '#f5f5f5', borderColor: '#e3e3e3' }}>
                <div className="text-center">
                    ...
                    <Link passHref href="/tutorial"><Button variant="primary" size="lg">CryFS Tutorial</Button></Link>
                </div>
            </Card>
        </Col>
    </Row>
