...
The same restriction mentioned for confidentiality also applies for integrity though. It [only ensures that the file contents you're reading were at some point written by you](https://github.com/rfjakob/gocryptfs-website/blob/master/docs/threat_model.md#dragon-read-write-access-to-full-ciphertext).
