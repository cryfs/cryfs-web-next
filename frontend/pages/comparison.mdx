...
However, like gocryptfs and EncFS, **Cryptomator does not hide file sizes or directory structure**
(see <a href="#metadata-encryption">why this matters</a>).
An attacker with access to your encrypted files can still see how many files you have, how large each file is,
and how they're organized into folders.
...
Gocryptfs, Cryptomator, EncFS, and eCryptfs don't encrypt directory structure. EncFS has [unpatched security vulnerabilities](https://defuse.ca/audits/encfs.htm) and is no longer actively maintained.
