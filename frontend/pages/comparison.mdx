...
<Row>
<Col md="6">
    <img src={VeraCryptImg} alt="VeraCrypt" className={styles.image} />
</Col>
<Col md="6">
...
<Col md="6">
<img src={GocryptfsImg} alt="Gocryptfs" className={styles.image} />
</Col>
</Row>
...
<Row>
<Col md="6">
<img src={EncfsImg} alt="EncFS" className={styles.image} />
</Col>
<Col md="6">
...
<Col md="7">
<img src={ECryptFsImg} alt="eCryptfs" className={styles.image} />
</Col>
</Row>
...
<Row>
<Col md="6">
<img src={CryFsImg} alt="CryFS" className={styles.image} />
</Col>
<Col md="5">
