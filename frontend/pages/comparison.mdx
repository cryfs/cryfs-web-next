...
It supports Linux, Mac, and has experimental Windows support since version 0.10.
...
CryFS is available for Linux and Mac, with experimental Windows support since version 0.10.
...
<ol className={styles.footnotes}>
    ...
    <li className={styles.footnotesLi}>CryFS supports this starting with version 0.10.</li>
    ...
    <li className={styles.footnotesLi}>There is experimental Windows support starting with CryFS version 0.10.</li>
