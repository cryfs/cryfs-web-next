...
<Row>
    <Col md={{size: 8, offset: 2}}>
        <Picture src={ComparisonImg} style={{marginTop: '5px', marginBottom: '30px', width: '100%', height: 'auto'}} alt="Encrypting your Dropbox" />
    </Col>
</Row>
...
so we will focus on its (inofficial) successor [VeraCrypt](https://veracrypt.io/) here.
...
While gocryptfs does encrypt file names, this is only <a href="#metadata-encryption">metadata obfuscation, not full metadata encryption</a>—the
directory structure, <a href="https://github.com/rfjakob/gocryptfs-website/blob/master/docs/threat_model.md#file-size-fingerprinting">file sizes</a>, and file counts remain visible.
