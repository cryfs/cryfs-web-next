...
<Row>
    <Col md={{size: 8, offset: 2}}>
        <img src={ComparisonImg.src} style={{marginTop: '5px', marginBottom: '30px', width: '100%'}} alt="Encrypting your Dropbox" />
    </Col>
</Row>
...
<Row>
<Col md="6">
    <img src={VeraCryptImg.src} alt="VeraCrypt" className={css(style.image)} />
</Col>
<Col md="6">
...
<Col md="6">
<img src={GocryptfsImg.src} alt="Gocryptfs" className={css(style.image)} />
</Col>
</Row>
...
<Row>
<Col md="6">
<img src={EncfsImg.src} alt="EncFS" className={css(style.image)} />
</Col>
<Col md="6">
...
<Col md="7">
<img src={ECryptFsImg.src} alt="eCryptfs" className={css(style.image)} />
</Col>
</Row>
...
<Row>
<Col md="6">
<img src={CryFsImg.src} alt="CryFS" className={css(style.image)} />
</Col>
<Col md="5">
