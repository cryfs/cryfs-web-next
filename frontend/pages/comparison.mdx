...
<Row>
    <Col md={{size: 8, offset: 2}}>
        <Image src={ComparisonImg} style={{marginTop: '5px', marginBottom: '30px', width: '100%'}} alt="Encrypting your Dropbox" />
    </Col>
</Row>
...
<Row>
<Col md="6">
    <Image src={VeraCryptImg} alt="VeraCrypt" className={css(style.image)} />
</Col>
<Col md="6">
...
<Col md="6">
<Image src={GocryptfsImg} alt="Gocryptfs" className={css(style.image)} />
</Col>
</Row>
...
<Row>
<Col md="6">
<Image src={EncfsImg} alt="EncFS" className={css(style.image)} />
</Col>
<Col md="6">
...
<Col md="7">
<Image src={ECryptFsImg} alt="eCryptfs" className={css(style.image)} />
</Col>
</Row>
...
<Row>
<Col md="6">
<Image src={CryFsImg} alt="CryFS" className={css(style.image)} />
</Col>
<Col md="5">
