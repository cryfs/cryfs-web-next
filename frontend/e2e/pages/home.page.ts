...
export class HomePage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.downloadButton = page.locator('section').filter({ hasText: 'Keep your data safe' }).getByRole('button', { name: 'Download' });
    this.tutorialButton = page.locator('section').filter({ hasText: 'Keep your data safe' }).getByRole('button', { name: 'Tutorial' });
